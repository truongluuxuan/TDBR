...
export default class MainActivity extends Component {
  ...
  add_Student = () => {
    ...
    realm.write(() => {
      ...
      if (findAndReplace(this.state.Student_Name, " ", "") == "" || findAndReplace(this.state.Student_Class, " ", "") == ""
        ...
        Toast.show('Bố giã đủ thông tin vào hộ con cái!', ToastAndroid.SHORT);
      } else {
        ...
        Toast.show('Thêm mới sinh viên thành công!', ToastAndroid.SHORT);
      }
  ...
  render() {
    ...
    return (
      ...
      <View>
        <View style={styles.ViewOfTextHeaderNoBack}>
          <Text style={styles.HeaderScreenNoBack}>Thêm mới học sinh/Sinh viên
              </Text>
              </View>
